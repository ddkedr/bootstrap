...
# of the bare IP. The script cannot discover it (reverse DNS is the
# provider's), so it asks; Enter skips.
PUBLIC_NAME=""
read -r -p "Public DNS name of this host, if any (e.g. lon.example.com): " PUBLIC_NAME
